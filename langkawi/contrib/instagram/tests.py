...
class TestInstagram(OAuth2Test, TestCase):
    ...
    def get_redirect_url(self):
        return reverse('langkawi:instagram:redirect')
    
    def get_callback_url(self):
        return reverse('langkawi:instagram:callback')
...
class TestAuthenticationBackend(TestCase):
    def test_authentication_backend_should_be_configured_in_settings(self):
        self.assertTrue('langkawi.contrib.instagram.auth.InstagramAuth' in settings.AUTHENTICATION_BACKENDS)
