...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QQProfile'
        db.create_table('social_qqprofile', (
            ...
            ('openid', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('gender', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True)),
        ))
        db.send_create_signal('qq', ['QQProfile'])

        # Adding model 'QQAccessToken'
        db.create_table('social_qqaccesstoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='access_token', unique=True, to=orm['qq.QQProfile'])),
        ...
        db.send_create_signal('qq', ['QQAccessToken'])


    def backwards(self, orm):
        # Deleting model 'QQProfile'
        db.delete_table('social_qqprofile')

        # Deleting model 'QQAccessToken'
        db.delete_table('social_qqaccesstoken')
    ...
    models = {
        ...
        'qq.qqaccesstoken': {
            'Meta': {'object_name': 'QQAccessToken', 'db_table': "'social_qqaccesstoken'"},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'access_token'", 'unique': 'True', 'to': "orm['qq.QQProfile']"}),
            'token_expires_in': ('django.db.models.fields.IntegerField', [], {})
        },
        'qq.qqprofile': {
            'Meta': {'object_name': 'QQProfile', 'db_table': "'social_qqprofile'"},
            'gender': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            'openid': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
