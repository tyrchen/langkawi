...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RenrenProfile.status'
        db.add_column('social_renrenprofile', 'status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RenrenProfile.status'
        db.delete_column('social_renrenprofile', 'status')
