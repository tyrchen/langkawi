...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RenrenProfile'
        db.create_table('social_renrenprofile', (
        ...
        db.send_create_signal('renren', ['RenrenProfile'])

        # Adding model 'RenrenAccessToken'
        db.create_table('social_renrenaccesstoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='access_token', unique=True, to=orm['renren.RenrenProfile'])),
        ...
        db.send_create_signal('renren', ['RenrenAccessToken'])


    def backwards(self, orm):
        # Deleting model 'RenrenProfile'
        db.delete_table('social_renrenprofile')

        # Deleting model 'RenrenAccessToken'
        db.delete_table('social_renrenaccesstoken')
    ...
    models = {
        ...
        'renren.renrenaccesstoken': {
            'Meta': {'object_name': 'RenrenAccessToken', 'db_table': "'social_renrenaccesstoken'"},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'access_token'", 'unique': 'True', 'to': "orm['renren.RenrenProfile']"}),
            'token_expires_in': ('django.db.models.fields.IntegerField', [], {})
        },
        'renren.renrenprofile': {
            'Meta': {'object_name': 'RenrenProfile', 'db_table': "'social_renrenprofile'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
